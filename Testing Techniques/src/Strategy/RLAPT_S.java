...
public class RLAPT_S {
     ...
     */
    public void adjustRLAPT_Q(int noTC, int nowPartitionIndex, int nextPartitionIndex, int nextnextPartitionIndex, boolean isKilledMutants) {
        ...
        RLAPT[nowPartitionIndex][nextPartitionIndex] += RLAPT_alpha * (r + RLAPT_gamma * RLAPT[nextPartitionIndex][nextnextPartitionIndex] - RLAPT[nowPartitionIndex][nextPartitionIndex]);
    }
